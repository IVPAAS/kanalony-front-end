...
},{"./kan-app":2,"angular":"angular","d3":"d3","jquery":"jquery","leaflet":"leaflet","lodash":"lodash","moment":"moment","nvd3":"nvd3"}],2:[function(require,module,exports){
'use strict';
...
},{"../kan-samples":19,"../kan-shell":31,"../kan-ui-charts":35,"angular-nvd3":"angular-nvd3","angular-ui-router":"angular-ui-router","ui-bootstrap":"ui-bootstrap"}],6:[function(require,module,exports){
'use strict';
...
},{"./controllers/charts/kan-area-chart":13,"./controllers/charts/kan-bar-chart":14,"./controllers/charts/kan-line-chart":15,"./controllers/charts/kan-pie-chart":16,"./controllers/maps/kan-map":17,"./directives/kan-sample-data-loader":18,"./kan-samples.config":20,"./kan-samples.module":21,"./kan-samples.run":22,"./services/data-adapters/kan-area-chart-s1":23,"./services/data-adapters/kan-bar-chart-s1":24,"./services/data-adapters/kan-bar-chart-s2":25,"./services/data-adapters/kan-line-chart-s1":26,"./services/data-adapters/kan-map-s1":27,"./services/data-adapters/kan-pie-chart-s1":28,"./services/kan-samples-data.service":29,"./services/kan-samples-helper.service":30}],20:[function(require,module,exports){
'use strict';
...
},{"../kan-kaltura-api":7,"../kan-ui-maps":40,"angular-leaflet-directive":"angular-leaflet-directive","ngStorage":"ngStorage"}],22:[function(require,module,exports){
...
},{"./kan-shell.config":32,"./kan-shell.module":33,"./kan-shell.run":34}],32:[function(require,module,exports){
'use strict';
...
},{"./kan-ui-charts.config":36,"./kan-ui-charts.module":37,"./kan-ui-charts.run":38}],36:[function(require,module,exports){
arguments[4][8][0].apply(exports,arguments)
...
},{"./directives/kan-map":39,"./kan-ui-maps.config":41,"./kan-ui-maps.module":42,"./kan-ui-maps.run":43,"./services/kan-countries-geojson.constant":44}],41:[function(require,module,exports){
arguments[4][8][0].apply(exports,arguments)
...
_.each(data,function(item)
{
    countriesDictionary[item.properties.name.toLowerCase()] = item;
});


module.exports = countriesDictionary;
